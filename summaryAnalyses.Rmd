...
if (analyze_my_algo) {
  ...
  which_data$hier = "hierarchical"
  which_data$learning_signal = "novelty"
  which_data$env_id = which_data$env_id
...
if (analyze_all_algos) {
  ...
  # Values of basic actions over time
  ...
  gg_n_disc_events_b = gg_n_disc_events +
    aes(color = paste(hier, learning_signal)) +
    labs(color = "Algorithm") +
    facet_wrap( ~ paste("Env.", env_id))
  ...
  if (gg_save) {
    identifier = paste(which_data$n_options_per_level, "_envs", envs, ".png", sep = "")
    ggsave(file.path(sum_plot_dir, paste("gg_n_disc_events_", identifier, sep = "")), gg_n_disc_events, width = 6, height = 5)
    ggsave(file.path(sum_plot_dir, paste("gg_n_disc_events_b_", identifier, sep = "")), gg_n_disc_events_b, width = 6, height = 5)
    file_name = paste("gg_n_events_", identifier, sep = "")
    ggsave(file.path(sum_plot_dir, file_name), gg_n_events, width = 5, height = 4)
    file_name = paste("gg_frac_events_", identifier, sep = "")
    ggsave(file.path(sum_plot_dir, file_name), gg_frac_events, width = 5, height = 4)
  }
